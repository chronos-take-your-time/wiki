...
As rotas terão o acesso mediado conforme determinado na seção [Autenticação de criação de contas e segurança](autenticação-e-contas.md), a API está disponível [neste repositório](https://github.com/chronos-take-your-time/server).